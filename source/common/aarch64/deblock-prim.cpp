...
{
    /* Strong luma NEON now comes from upstream ToT (loopfilter-prim.cpp,
     * the same baf2df0/155064d code this file originally backported) —
     * do not shadow it here.  Rebase 2026-08-01. */
